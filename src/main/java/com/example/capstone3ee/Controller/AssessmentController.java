...
public class AssessmentController {
    ...
    public ResponseEntity addAssessment(@PathVariable Integer userId,@Valid @RequestBody Assessment assessment) {
        assessmentService.addAssessment(userId,assessment);
